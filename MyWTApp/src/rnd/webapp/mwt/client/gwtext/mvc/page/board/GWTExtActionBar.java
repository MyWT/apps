...
public class GWTExtActionBar extends AbstractMVCBean implements ActionBar {
	...
	private void performSaveAction() {
		...
		ApplicationRequest req = ARCreator.createSaveRequest(getCurrentFormBoard().getModuleName(), getCurrentFormBoard().getApplicationBeanName(), getCurrentFormBoard().getViewName(), formModel.getApplicationBean());
